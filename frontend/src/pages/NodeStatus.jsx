...
export default function NodeStatus() {
  return (
    <div className="h-full">
      <h2 className="text-2xl font-bold text-black mb-6">Hardware Fleet Status</h2>
        ...
        {hardwareNodes.map((node) => (
          ...
          >
            ...
            <div className="flex justify-between items-center border-b border-slate-100 pb-4 mb-4">
              <h3 className="text-lg font-bold text-black">{node.id}</h3>
            ...
            <p className="text-sm text-white/30 mb-6 font-medium">{node.location}</p>
            ...
            <div className="flex flex-col gap-4 text-sm text-slate-700">
              ...
              <div className="flex items-center gap-3">
                {node.charging ? (
                  ...
                  <Battery size={20} className={node.battery > 20 ? "text-white/50" : "text-rose-500"} />
                )}
