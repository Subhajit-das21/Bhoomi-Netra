    ...
    <div className="h-full bg-[#0B1120] text-slate-200 p-6 flex flex-col font-sans overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-slate-400">Real-time risk assessment and shelter routing</p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 pb-10">
        <div className="xl:col-span-2 bg-[#111827] border border-slate-700/50 rounded-xl overflow-hidden relative shadow-lg flex flex-col min-h-[500px]">
          <div className="p-4 bg-[#151D2C] border-b border-slate-700/50 flex justify-between items-center z-10">
            <h2 className="text-sm font-bold text-slate-200 uppercase tracking-wider flex items-center gap-2">
              <Navigation size={16} className="text-blue-400" /> Active Evacuation Routes
            </h2>
          </div>
          ...
          <div className="flex-1 relative z-0">
            <MapContainer center={[22.636, 88.440]} zoom={14} style={{ height: '100%', width: '100%', backgroundColor: '#0B1120' }}>
              ...
              <Marker position={[22.642, 88.448]} icon={shelterIcon}>
                <Popup><strong className="text-slate-800">Rajarhat Community Hall</strong><br/>Capacity: 320 / 500</Popup>
              </Marker>
        ...
        <div className="bg-[#111827] border border-slate-700/50 rounded-xl p-5 shadow-lg flex flex-col overflow-y-auto min-h-[400px]">
          <h2 className="text-sm font-bold text-slate-200 uppercase tracking-wider mb-4 flex items-center gap-2">
            <Users size={18} className="text-blue-400"/> Demographics at Risk
          </h2>
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-rose-900/20 border border-rose-500/30 p-4 rounded-lg">
              ...
              <p className="text-xs text-slate-400">Immediate mandatory evacuation required.</p>
            </div>
            <div className="bg-amber-900/20 border border-amber-500/30 p-4 rounded-lg">
              ...
              <p className="text-xs text-slate-400">Voluntary evacuation advised. Standby for updates.</p>
            </div>
          </div>
          ...
          <div className="bg-[#1A2332] border border-slate-700/50 p-4 rounded-lg shadow-sm">
            <div className="flex justify-between items-start mb-2">
              <h3 className="font-bold text-white text-sm">Rajarhat Community Hall</h3>
              <span className="text-xs font-medium text-slate-400 text-right">Distance<br/><span className="text-blue-400 font-bold">1.2 km</span></span>
            </div>
            <div className="mt-4">
              ...
              <p className="text-[10px] text-slate-500 text-right">64% Full</p>
            </div>
            <button className="mt-4 w-full bg-[#2A364A] hover:bg-[#334155] border border-slate-600 text-white text-xs font-bold py-2 rounded transition-colors flex items-center justify-center gap-2">
